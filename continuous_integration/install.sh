...
pip install -i http://overwatch.pnl.gov:8000/simple/ --trusted-host overwatch.pnl.gov -pyyaml Flask requests selenium nose-cov nose-exclude mock sqlalchemy flask-testing blinker flask-sqlalchemy flask-migrate flask-fixtures ijson
