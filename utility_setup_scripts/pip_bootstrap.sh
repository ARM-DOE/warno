...
pip install gunicorn psycogreen psutil enum34 sqlalchemy alembic flask-sqlalchemy flask-migrate flask-fixtures flask-testing flask-user configparser flask-user flask-restless
