...
class IrisBite(db.Model):
    ...
    ab842_digital_az_timeout = db.Column(db.String)
    ab842_digital_checksum_error = db.Column(db.String)
    ab842_digital_diagnostic_error = db.Column(db.String)
    ab842_digital_el_timeout = db.Column(db.String)
    ab842_digital_frequency_exceeded = db.Column(db.String)
    ab842_digital_light_cntrl_reserve = db.Column(db.String)
    ab842_digital_max__accel_flag = db.Column(db.String)
    ab842_digital_max__velocity_flag = db.Column(db.String)
    ab842_digital_min__accel_flag = db.Column(db.String)
    ab842_digital_min__velocity_flag = db.Column(db.String)
    ab842_digital_position_error = db.Column(db.String)
    ab842_digital_position_limits_exc = db.Column(db.String)
    ab842_digital_startup_error = db.Column(db.String)
    ab842_digital_temp_out_of_range = db.Column(db.String)
    ab842_digital_volt__out_of_range = db.Column(db.String)
    ...
    internal_saux_dehy__duty_cycle = db.Column(db.String)
    internal_saux_dehy__wg__pressure = db.Column(db.String)
    internal_saux_low_el__interlock = db.Column(db.String)
    internal_saux_main_power_status = db.Column(db.String)
    internal_saux_noise_source_status = db.Column(db.String)
    internal_saux_pedestal_interlock = db.Column(db.String)
    internal_saux_radome_door_ilock = db.Column(db.String)
    internal_saux_servo_pdu_power = db.Column(db.String)
    internal_saux_servo_power_status = db.Column(db.String)
    internal_saux_stalo_status = db.Column(db.String)
    internal_saux_tx_pdu_power = db.Column(db.String)
    internal_saux_ups_status = db.Column(db.String)
    internal_saux_waveguide_sw_h = db.Column(db.String)
    internal_saux_waveguide_sw_v = db.Column(db.String)
    ipc15hc_digital_alignment_error = db.Column(db.String)
    ipc15hc_digital_az_timeout = db.Column(db.String)
    ipc15hc_digital_bad_hall_state = db.Column(db.String)
    ipc15hc_digital_bridge_foldback_err = db.Column(db.String)
    ipc15hc_digital_bridge_foldback_war = db.Column(db.String)
    ipc15hc_digital_bridge_hardware_err = db.Column(db.String)
    ipc15hc_digital_bridge_temp_fault = db.Column(db.String)
    ipc15hc_digital_control_pwr_active = db.Column(db.String)
    ipc15hc_digital_drive_enabled = db.Column(db.String)
    ipc15hc_digital_drive_faulted_error = db.Column(db.String)
    ipc15hc_digital_drive_param_error = db.Column(db.String)
    ipc15hc_digital_drive_temp_fault = db.Column(db.String)
    ipc15hc_digital_el_timeout = db.Column(db.String)
    ipc15hc_digital_encoder_loss_fault = db.Column(db.String)
    ipc15hc_digital_encoder_read_fault = db.Column(db.String)
    ipc15hc_digital_excess_enc__count = db.Column(db.String)
    ipc15hc_digital_excess_speed_at_ena = db.Column(db.String)
    ipc15hc_digital_excessive_position = db.Column(db.String)
    ipc15hc_digital_excessive_velocity = db.Column(db.String)
    ipc15hc_digital_feedback_failure = db.Column(db.String)
    ipc15hc_digital_low_voltage_at_ena = db.Column(db.String)
    ipc15hc_digital_motor_config_error = db.Column(db.String)
    ipc15hc_digital_motor_config_warn = db.Column(db.String)
    ipc15hc_digital_motor_current_high = db.Column(db.String)
    ipc15hc_digital_motor_temp_fault = db.Column(db.String)
    ipc15hc_digital_motor_therm_model = db.Column(db.String)
    ipc15hc_digital_network_loss_fault = db.Column(db.String)
    ipc15hc_digital_over_voltage_err = db.Column(db.String)
    ipc15hc_digital_peak_current_high = db.Column(db.String)
    ipc15hc_digital_power_regen_fault = db.Column(db.String)
    ipc15hc_digital_power_regen_warning = db.Column(db.String)
    ipc15hc_digital_pwm_not_active = db.Column(db.String)
    ipc15hc_digital_shaft_power_limited = db.Column(db.String)
    ipc15hc_digital_torque_rating_high = db.Column(db.String)
    ipc15hc_digital_under_voltage_err = db.Column(db.String)
    ipc15hc_digital_user_fault = db.Column(db.String)
    ...
    radxcm_digital_24v = db.Column(db.String)
    radxcm_digital_28v = db.Column(db.String)
    radxcm_digital_360v = db.Column(db.String)
    radxcm_digital_5v = db.Column(db.String)
    radxcm_digital_airflow_switch = db.Column(db.String)
    radxcm_digital_cooldown_state = db.Column(db.String)
    radxcm_digital_cooling_air = db.Column(db.String)
    radxcm_digital_dc_dc_temp_switch = db.Column(db.String)
    radxcm_digital_door_interlock = db.Column(db.String)
    radxcm_digital_duty_cycle_fault = db.Column(db.String)
    radxcm_digital_fault_state = db.Column(db.String)
    radxcm_digital_filament_current = db.Column(db.String)
    radxcm_digital_filament_v = db.Column(db.String)
    radxcm_digital_forward_power = db.Column(db.String)
    radxcm_digital_hv_current = db.Column(db.String)
    radxcm_digital_hv_current_fault = db.Column(db.String)
    radxcm_digital_hvm = db.Column(db.String)
    radxcm_digital_hvp = db.Column(db.String)
    radxcm_digital_local_mode_control = db.Column(db.String)
    radxcm_digital_m15 = db.Column(db.String)
    radxcm_digital_mag_current_avg = db.Column(db.String)
    radxcm_digital_mag_current_fault = db.Column(db.String)
    radxcm_digital_mag_temp = db.Column(db.String)
    radxcm_digital_magnetron_current = db.Column(db.String)
    radxcm_digital_modulator_temp_swit = db.Column(db.String)
    radxcm_digital_p15 = db.Column(db.String)
    radxcm_digital_pfc1_status = db.Column(db.String)
    radxcm_digital_pfc2_status = db.Column(db.String)
    radxcm_digital_powerup_state = db.Column(db.String)
    radxcm_digital_pulse_width_fault = db.Column(db.String)
    radxcm_digital_radiate_state = db.Column(db.String)
    radxcm_digital_radtec_xcm_timeout = db.Column(db.String)
    radxcm_digital_reset_i = db.Column(db.String)
    radxcm_digital_reset_v = db.Column(db.String)
    radxcm_digital_reverse_power_h = db.Column(db.String)
    radxcm_digital_reverse_power_v = db.Column(db.String)
    radxcm_digital_shutdown_state = db.Column(db.String)
    radxcm_digital_spare_switch_input = db.Column(db.String)
    radxcm_digital_standby_state = db.Column(db.String)
    radxcm_digital_warmup_state = db.Column(db.String)
    radxcm_digital_waveguide_pressure = db.Column(db.String)
