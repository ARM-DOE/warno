...
WidgetManager.prototype.buildFromSchematic = function(dashboardSchematic) {
    ...
    for (var i = 0; i < dashboardSchematic.length; i ++) {
        ...
        if (dashboardSchematic[i]["type"] == "WDualHistogram") {
            this.addWDualHistogram(dashboardSchematic[i]["data"]);
        }
        if (dashboardSchematic[i]["type"] == "WStatusPlot") {
            this.addWStatusPlot(dashboardSchematic[i]["data"]);
        }
        if (dashboardSchematic[i]["type"] == "WRealTimeGauge") {
            this.addWRealTimeGauge(dashboardSchematic[i]["data"]);
        }
        if (dashboardSchematic[i]["type"] == "WInstrumentGraph") {
            this.addWInstrumentGraph(dashboardSchematic[i]["data"]);
        }
        if (dashboardSchematic[i]["type"] == "WHistogram") {
            this.addWHistogram(dashboardSchematic[i]["data"]);
        }
    }
}
...
WidgetManager.prototype.addWDualHistogram = function(schematic) {
    var newWDualHistogram = new WDualHistogram(this, this.newWidgetId, this.containerDiv, this.controllerUrl, schematic);
    this.widgets.push(newWDualHistogram);
    this.newWidgetId +=1;
    if (this.hasTightBorders) {
        newWDualHistogram.tightBorders();
    }
};

WidgetManager.prototype.addWHistogram = function(schematic) {
    var newWHistogram = new WHistogram(this, this.newWidgetId, this.containerDiv, this.controllerUrl, schematic);
    this.widgets.push(newWHistogram);
    this.newWidgetId +=1;
    if (this.hasTightBorders) {
        newWHistogram.tightBorders();
    }
};
...
WidgetManager.prototype.addWInstrumentGraph = function(schematic) {
    var newInstrumentGraph = new WInstrumentGraph(this, this.newWidgetId, this.containerDiv, this.controllerUrl,
                                             this.genGraphURL, schematic);
    this.widgets.push(newInstrumentGraph);
    this.newWidgetId += 1;
    if (this.hasTightBorders) {
...
WidgetManager.prototype.addWStatusPlot = function(schematic) {
    newWStatusPlot = new WStatusPlot(this, this.newWidgetId, this.containerDiv, this.controllerUrl, this.statusPlotURL, schematic);
    this.widgets.push(newWStatusPlot);
    this.newWidgetId += 1;
    if (this.hasTightBorders) {
        newWStatusPlot.tightBorders();
    };
};

WidgetManager.prototype.addWRealTimeGauge = function(schematic) {
    var newRealTimeGauge = new WRealTimeGauge(this, this.newWidgetId, this.containerDiv, this.controllerUrl, schematic);
    this.widgets.push(newRealTimeGauge);
    this.newWidgetId += 1;
    if (this.hasTightBorders) {
        newRealTimeGauge.tightBorders();
...
function WStatusPlot(manager, id, containerDiv, controllerURL, statusPlotURL, schematic) {
    Widget.call(this, manager, id, containerDiv, schematic);
...
WStatusPlot.prototype = Object.create(Widget.prototype);
WStatusPlot.prototype.constructor = WStatusPlot;
...
WStatusPlot.prototype.buildControlDiv = function() {
    this.controlDiv.innerHTML = "WStatusPlot";
    this.parentDiv.appendChild(this.controlDiv);
...
WStatusPlot.prototype.saveDashboard = function () {
    var configRepresentation = this.getConfigParameterRepresentations();
    var data = {"siteId": this.siteId, "configParameters": configRepresentation};
    return {"type": "WStatusPlot", "data": data};
};

WStatusPlot.prototype.loadDashboard = function(schematic) {
    this.finishedLoading = false;
...
WStatusPlot.prototype.ajaxLoadURL = function(element, url) {
    var xmlHttp = new XMLHttpRequest();
...
WStatusPlot.prototype.triggerJob = function() {
    this.generateStatusPlot();
};

WStatusPlot.prototype.generateStatusPlot = function() {
    this.activeCounter = true;
...
function WRealTimeGauge(manager, id, containerDiv, controllerURL, schematic) {
    Widget.call(this, manager, id, containerDiv, schematic);
...
WRealTimeGauge.prototype = Object.create(Widget.prototype);
WRealTimeGauge.prototype.constructor = WRealTimeGauge;

WRealTimeGauge.prototype.buildControlDiv = function() {
    this.controlDiv.innerHTML = "WRealTimeGauge";
    this.parentDiv.appendChild(this.controlDiv);

    this.loadDashboard();  // Loads the schematic's non-config parameters into WRealTimeGauge
...
WRealTimeGauge.prototype.ajaxLoadURL = function(element, url, loadDashboard) {
    var xmlHttp = new XMLHttpRequest();
    var that = this;
    xmlHttp.onreadystatechange = function() {
        if (xmlHttp.readyState == 4 && xmlHttp.status == 200)
...
WRealTimeGauge.prototype.loadDashboard = function () {
...
WRealTimeGauge.prototype.initializeElements = function (loadDashboard) {
...
WRealTimeGauge.prototype.updateSelect = function(loadDashboard) {
...
WRealTimeGauge.prototype.saveDashboard = function() {
    var configRepresentation = this.getConfigParameterRepresentations();
    data = {
    ...
    return {"type": "WRealTimeGauge", "data": data};
};

WRealTimeGauge.prototype.generateRealTimeGauge = function () {
...
WRealTimeGauge.prototype.updateLastReceived = function() {
...
WRealTimeGauge.triggerJob = function () {
    this.generateRealTimeGauge();
};

WRealTimeGauge.prototype.updateTitle = function() {
...
WRealTimeGauge.prototype.hideController = function () {
    element = document.getElementById("real-time-gauge-controller-" + this.id);
    element.style.display = "none";
    this.controllerHidden = true;
};

WRealTimeGauge.prototype.revealController = function () {
    element = document.getElementById("real-time-gauge-controller-" + this.id);
...
function RealTimeGauge(manager, id, containerDiv, controllerUrl, schematic) {
    ...
    this.div = document.createElement('div');
    this.div.className = 'wd';
    this.div.innerHTML = "Real Time Gauge";
...
function WHistogram(manager, id, containerDiv, controllerURL, schematic) {
    Widget.call(this, manager, id, containerDiv, schematic);
...
WHistogram.prototype = Object.create(Widget.prototype);
WHistogram.prototype.constructor = WHistogram;

WHistogram.prototype.buildDefaultParameters = function () {
    this.configParameters = [
...
WHistogram.prototype.buildControlDiv = function () {
    this.controlDiv.innerHTML = "WHistogram";
    this.parentDiv.appendChild(this.controlDiv);

    this.loadDashboard();  // Loads the schematic's non-config parameters into WHistogram
...
WHistogram.prototype.ajaxLoadURL = function(element, url, loadDashboard) {
    var xmlHttp = new XMLHttpRequest();
    var that = this;
    xmlHttp.onreadystatechange = function() {
        if (xmlHttp.readyState == 4 && xmlHttp.status == 200)
...
WHistogram.prototype.loadDashboard = function () {
    var schematic = this.schematic;
    if (schematic) {
        validSchematic = true;
        this.controllerHidden = schematic["controllerHidden"]; // Boolean, true if controller is collapsed
...
WHistogram.prototype.initializeElements = function (loadDashboard) {
    var that = this;  // Substitution allows inline function assignments to reference 'this' rather than themselves
...
WHistogram.prototype.updateSelect = function(loadDashboard) {
    var instrumentSelect = document.getElementById("instrument-select-" + this.id);
    var attributeSelect = document.getElementById("attribute-select-" + this.id);
    var attributeInput = document.getElementById("attribute-input-" + this.id);
...
WHistogram.prototype.saveDashboard = function () {
    var configRepresentation = this.getConfigParameterRepresentations();
    data = {
        "controllerHidden": this.controllerHidden,
    ...
    return {"type": "WHistogram", "data": data};
};

WHistogram.prototype.generateHistogram = function () {
    this.activeCounter = true; // Activates the periodic update checks
...
WHistogram.prototype.updateLastReceived = function () {
    var statusBubble = document.getElementById("receive-status-" + this.id);
    if (this.lastReceived == null) {
        statusBubble.className = "db_receive_status";
        document.getElementById("last-received-" + this.id).innerHTML = "No Data";
...
WHistogram.prototype.getAutomaticBeginning = function () {
    var now = new Date();
...
WHistogram.prototype.hideController = function () {
    element = document.getElementById("histogram-controller-" + this.id);
    element.style.display = "none";
    this.controllerHidden = true;
};

WHistogram.prototype.revealController = function () {
    element = document.getElementById("histogram-controller-" + this.id);
    element.style.display = "";
    this.controllerHidden = false;
};

WHistogram.prototype.showConstraintAuto = function () {
...
WHistogram.prototype.showConstraintCustom = function () {
    var autoElement = document.getElementById("auto-times-" + this.id);
    var customElement = document.getElementById("custom-times-" + this.id);
    var constraintButton = document.getElementById("time-constraint-switch-" + this.id);
...
function WDualHistogram(manager, id, containerDiv, controllerURL, schematic) {
    Widget.call(this, manager, id, containerDiv, schematic);
...
WDualHistogram.prototype = Object.create(Widget.prototype);
WDualHistogram.prototype.constructor = WDualHistogram;

WDualHistogram.prototype.buildDefaultParameters = function () {
...
WDualHistogram.prototype.buildControlDiv = function () {
    this.controlDiv.innerHTML = "WDualHistogram";
    this.parentDiv.appendChild(this.controlDiv);

    this.loadDashboard();  // Loads the schematic's non-config parameters into WDualHistogram
...
WDualHistogram.prototype.ajaxLoadURL = function(element, url, loadDashboard) {
    var xmlHttp = new XMLHttpRequest();
    var that = this;
    xmlHttp.onreadystatechange = function() {
        if (xmlHttp.readyState == 4 && xmlHttp.status == 200)
...
WDualHistogram.prototype.loadDashboard = function () {
    // Load in non-configuration parameters.  Configuration parameters should load where config is built
    var schematic = this.schematic;
    if (schematic) {
        this.controllerHidden = schematic["controllerHidden"]; // Boolean, true if controller is collapsed
...
WDualHistogram.prototype.initializeElements = function (loadDashboard) {
    var that = this;  // Substitution allows inline function assignments to reference 'this' rather than themselves
...
WDualHistogram.prototype.updateSelect = function(loadDashboard) {
    var instrumentSelect = document.getElementById("instrument-select-" + this.id);
...
WDualHistogram.prototype.saveDashboard = function () {
    var configRepresentation = this.getConfigParameterRepresentations();
    data = {
        "controllerHidden": this.controllerHidden,
        "startUTC": this.startUTC,
    ...
    return {"type": "WDualHistogram", "data": data};
}

WDualHistogram.prototype.generateDualHistogram = function () {
    this.activeCounter = true;  // Activates the periodic update checks
...
WDualHistogram.prototype.updateLastReceived = function () {
    var statusBubble = document.getElementById("receive-status-" + this.id);
    if (this.lastReceived == null) {
        statusBubble.className = "db_receive_status";
        document.getElementById("last-received-" + this.id).innerHTML = "No Data";
...
WDualHistogram.prototype.getAutomaticBeginning = function () {
    var now = new Date();
    if (this.constraintRange == "tenminute") {
        return new Date(now.setMinutes(now.getMinutes() - 10));
    } if (this.constraintRange == "hour") {
...
WDualHistogram.prototype.triggerJob = function() {
    this.generateDualHistogram();
};


WDualHistogram.prototype.hideController = function () {
    element = document.getElementById("histogram-controller-" + this.id);
    element.style.display = "none";
    this.controllerHidden = true;
};

WDualHistogram.prototype.revealController = function () {
    element = document.getElementById("histogram-controller-" + this.id);
    element.style.display = "";
    this.controllerHidden = false;
};

WDualHistogram.prototype.showConstraintAuto = function () {
    var autoElement = document.getElementById("auto-times-" + this.id);
    var customElement = document.getElementById("custom-times-" + this.id);
    var constraintButton = document.getElementById("time-constraint-switch-" + this.id);
    autoElement.style.display = "block";
...
WDualHistogram.prototype.showConstraintCustom = function () {
    var autoElement = document.getElementById("auto-times-" + this.id);
    var customElement = document.getElementById("custom-times-" + this.id);
    var constraintButton = document.getElementById("time-constraint-switch-" + this.id);
    autoElement.style.display = "none";
...
function WInstrumentGraph(manager, id, containerDiv, controllerURL, genGraphURL, schematic) {
    Widget.call(this, manager, id, containerDiv, schematic);
...
WInstrumentGraph.prototype = Object.create(Widget.prototype);
WInstrumentGraph.prototype.constructor = WInstrumentGraph;

WInstrumentGraph.prototype.buildDefaultParameters = function () {
    this.configParameters = [
        new ConfigInteger(this.id, "triggerTickNumber", "Update Frequency in Minutes (positive integer): ", 1, 1, null),
...
WInstrumentGraph.prototype.buildControlDiv = function () {
    this.controlDiv.innerHTML = "WInstrumentGraph";
    this.parentDiv.appendChild(this.controlDiv);

    this.loadDashboard();  // Loads the schematic's non-config parameters into WInstrumentGraph
...
WInstrumentGraph.prototype.ajaxLoadURL = function(element, url, loadDashboard) {
    var xmlHttp = new XMLHttpRequest();
    var that = this;
    xmlHttp.onreadystatechange = function() {
        if (xmlHttp.readyState == 4 && xmlHttp.status == 200)
...
WInstrumentGraph.prototype.loadDashboard = function () {
    // Load in non-configuration parameters.  Configuration parameters should load where config is built
    var schematic = this.schematic;
    if (schematic) {
        this.controllerHidden = schematic["controllerHidden"];  // Boolean, true if controller is collapsed
...
WInstrumentGraph.prototype.initializeElements = function (loadDashboard) {
    var that = this;  // Substitution allows inline function assignments to reference 'this' rather than themselves
...
WInstrumentGraph.prototype.updateSelect = function(loadDashboard) {
    var instrumentSelect = document.getElementById("instrument-select-" + this.id);
    if (loadDashboard) {
        if (this.instrumentId) {
            instrumentSelect.value = this.instrumentId;
...
WInstrumentGraph.prototype.saveDashboard = function() {
    var configRepresentation = this.getConfigParameterRepresentations();
    ...
    return {"type": "WInstrumentGraph", "data": data}
};

WInstrumentGraph.prototype.generateInstrumentGraph = function(){
...
WInstrumentGraph.prototype.enableStats = function() {
...
WInstrumentGraph.prototype.addAttribute = function () {
...
WInstrumentGraph.prototype.removeAttribute = function (id) {
...
WInstrumentGraph.prototype.updateWithValues = function(values) {
...
WInstrumentGraph.prototype.updateLastReceived = function() {
    var statusBubble = document.getElementById("receive-status-" + this.id);
    if (this.lastReceived == null) {
        statusBubble.className = "db_receive_status";
        document.getElementById("last-received-" + this.id).innerHTML = "No Data";
...
WInstrumentGraph.prototype.updateInstrumentGraph = function() {
...
WInstrumentGraph.prototype.trimOldGraphData = function () {
...
WInstrumentGraph.prototype.getAutomaticBeginning = function () {
    var now = new Date();
    if (this.constraintRange == "tenminute") {
        return new Date(now.setMinutes(now.getMinutes() - 10));
    } if (this.constraintRange == "hour") {
...
// Hide/Show Functions
WInstrumentGraph.prototype.hideController = function () {
    var element = document.getElementById("inst-graph-controller-" + this.id);
    element.style.display = "none";
    this.controllerHidden = true;
};

WInstrumentGraph.prototype.revealController = function () {
    var element = document.getElementById("inst-graph-controller-" + this.id);
    element.style.display = "";
    this.controllerHidden = false;
};

WInstrumentGraph.prototype.toggleStatsHidden = function () {
...
WInstrumentGraph.prototype.showConstraintAuto = function () {
    var autoElement = document.getElementById("auto-times-" + this.id);
    var customElement = document.getElementById("custom-times-" + this.id);
    var constraintButton = document.getElementById("time-constraint-switch-" + this.id);
    autoElement.style.display = "block";
...
WInstrumentGraph.prototype.showConstraintCustom = function () {
    var autoElement = document.getElementById("auto-times-" + this.id);
    var customElement = document.getElementById("custom-times-" + this.id);
    var constraintButton = document.getElementById("time-constraint-switch-" + this.id);
    autoElement.style.display = "none";
