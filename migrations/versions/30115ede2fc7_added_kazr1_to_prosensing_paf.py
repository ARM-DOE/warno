...
def upgrade():
    ...
    op.add_column('prosensing_paf', sa.Column('counts_to_voltage_scalex', sa.Float(), nullable=True))
    ...
    op.add_column('prosensing_paf', sa.Column('fan_sp_celciusx', sa.Float(), nullable=True))
    ...
    op.add_column('prosensing_paf', sa.Column('heater_sp_celciusx', sa.Float(), nullable=True))
